...
function EditProduct() {
  ...
  const handleSubmit = (e) => {
    ...
    // Only generate SKU if it's empty and hasSKU is true
      ...
      <form onSubmit={handleSubmit}>
        <FormLayout>
          ...
          <div className="right-column">
                ...
                <>
                  ...
                  <FormGroup>
                    ...
                    <input 
                      ...
                      onChange={handleInputChange}
                    />
                    <div className="helper-text">Alert when stock falls below this level</div>
                  </FormGroup>
            ...
            <SaveButton type="submit">Update Product</SaveButton>
          </div>
        </FormLayout>
      </form>
