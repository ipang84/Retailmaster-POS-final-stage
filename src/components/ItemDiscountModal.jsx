...
function ItemDiscountModal({ isOpen, onClose, item, onApplyDiscount }) {
  ...
  }, [discountType, discountValue, item]);
      ...
      <ModalContent>
        ...
        <ModalBody>
          <ItemInfo>
            ...
            <div className="item-price">${parseFloat(item.price).toFixed(2)} × {item.quantity}</div>
          </ItemInfo>
          ...
          <FormGroup>
            ...
            <input 
              ...
              min="0"
              max={discountType === 'percentage' ? '100' : (item.price * item.quantity).toString()}
              step="0.01"
            />
            <div className="helper-text">
              {discountType === 'percentage' 
                ? 'Enter a percentage between 0 and 100' 
                : `Enter an amount between 0 and ${(item.price * item.quantity).toFixed(2)}`}
            </div>
            ...
            <div className="discount-preview">
              ...
              <div className="preview-row">
                ...
                <span>${((item.price * item.quantity) - discountAmount).toFixed(2)}</span>
              </div>
            </div>
          </FormGroup>
        </ModalBody>
